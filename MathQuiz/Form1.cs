...
namespace MathQuiz
{
    public partial class Form1 : Form
    {
        ...
        private bool CheckTheAnswer()
        {
          ...
          && (dividend / divisor == Math.Round(quotient.Value)))
                return true;
            else
                return false;
        }
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            actualDate.Text = today.ToString("dd") + " " + today.ToString("MMMM") + " " + today.ToString("yyyy") ;
        }
        ...
        private void sum_answer(object sender, EventArgs e)
        {
            if (addend1 + addend2 == sum.Value)
            {
        ...
        private void difference_answer(object sender, EventArgs e)
        {
        ...
        private void product_answer(object sender, EventArgs e)
        {
        ...
        private void division_answer(object sender, EventArgs e)
        {
            if(dividend / divisor == Math.Round(quotient.Value))
            {
